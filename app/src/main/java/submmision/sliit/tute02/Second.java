...
public class Second extends AppCompatActivity {
    ...
    String takeExtra1, takeExtra2, n1, n2;
    Button addBtn, minusBtn, multyBtn, divideBtn;
    EditText number01, number02;
    double result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number01 = (EditText) findViewById(R.id.num01);
        number02 = (EditText) findViewById(R.id.num02);
